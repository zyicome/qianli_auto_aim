...
void NumberClassifier::extractNumbers(const cv::Mat & src, std::vector<LightArmor> & armors)
{
...
void NumberClassifier::classify(std::vector<LightArmor> & armors)
{
  for (auto & armor : armors) {
